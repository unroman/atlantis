...
//    private static final Item.Properties ATLANTIS_GLYPH = new Item.Properties();

    //Energy TODO fix Energy Items
  //  public static final RegistryObject<Item> ATLANTEAN_AMULET = register("atlantean_amulet", AtlanteanAmuletItem::new);
  //  public static final RegistryObject<Item> ATLANTEAN_SPEAR = register("atlantean_spear", () -> new AtlanteanSpearItem(new Item.Properties().tab(AtlantisGroup.MAIN).rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> ATLANTEAN_JELLYFISH_2_EGG = register("atlantean_jellyfish_2_egg", () -> new ForgeSpawnEggItem(AtlantisEntityInit.JELLYFISH2, 0x347BC2, 0x004080, new Item.Properties()));
    ...
    public static final RegistryObject<Item> CRAB_LEGS = register("crab_legs", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().meat().nutrition(6).saturationMod(10.0f).build())));
    public static final RegistryObject<Item> SHRIMP = register("shrimp", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().meat().nutrition(5).saturationMod(2.0f).effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 100), 0.05f).build())));
    public static final RegistryObject<Item> COOKED_SHRIMP = register("cooked_shrimp", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().meat().nutrition(2).saturationMod(5.0f).build())));
    ...
    public static final RegistryObject<Item> JELLYFISH_2_BUCKET = register("jellyfish_2_bucket", ()->new AtlanteanEntityBucketItem(AtlantisEntityInit.JELLYFISH2, ()->Fluids.WATER, ()->SoundEvents.BUCKET_EMPTY_FISH, (new Item.Properties()).stacksTo(1)));
